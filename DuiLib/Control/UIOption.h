...
namespace DuiLib
{
	...
	public:
		...
		void SetSelectedBorderColor(DWORD dwColor);
		DWORD GetSelectedBorderColor() const;
		RECT GetSelectedBorderSize() const;
		void SetSelectedBorderSize(RECT rc);
		void SetSelectedBorderSize(int iSize);
