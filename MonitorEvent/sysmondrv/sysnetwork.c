...
)
{
	...
	do
	{
		...
		*/
		...
		pBuf1 = (PINTERNAL_TCP_TABLE_ENTRY)VerifierExAllocatePoolTag(0x38 * Count, 'TCMM');
		pBuf2 = (PNSI_STATUS_ENTRY)VerifierExAllocatePoolTag(0x10 * Count, 'TCMM');
		pBuf3 = (PNSI_PROCESSID_INFO)VerifierExAllocatePoolTag(0x20 * Count, 'TCMM');
		...
		*/
		...
		pBuf4 = (PINTERNAL_UDP_TABLE_ENTRY)VerifierExAllocatePoolTag(0x1c * Count, 'UDMM');
		pBuf5 = (PNSI_PROCESSID_INFO)VerifierExAllocatePoolTag(0x20 * Count, 'UDMM');
		if (!pBuf4 || !pBuf5)
			break;
